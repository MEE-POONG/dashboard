...
interface EditCustomersModalProps {
    isEditModalOpen: boolean;
    onClose: () => void;
}


const EditCustomersModal: React.FC<EditCustomersModalProps> = ({ isEditModalOpen, onClose }) => {
            ...
            <div className="">
                ...
                <div className="bg-white p-3 md:p-6 rounded shadow-md ">
                    <div className='flex items-center justify-between'>
                        <h1 className='text-xl font-bold'>แก้ไขข้อมูลลูกค้า</h1>
